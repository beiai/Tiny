...
namespace UniEngine.Module.Sound.SoundAgent
{
    /// <summary>
    /// 声音代理。
    /// </summary>
    ...
    {
        private readonly SoundGroup.SoundGroup _soundGroup;
        ...
        public SoundAgent(SoundGroup.SoundGroup soundGroup, ISoundHelper soundHelper, ISoundAgentHelper soundAgentHelper)
        {
            if (soundGroup == null)
            {
